...
int OpenBmp(const char * const pszFileName, char** const ppBuf, BITMAPHEADER *pHeader)
{
    ...
    *ppBuf = (char*)malloc(filesize-BMPFILEHEADERSIZE);
    ...
    printf("file size: %d\n", filesize);
    printf("bitmapoffset - header size: %lu\n", fileheader.BitmapOffset - BMPFILEHEADERSIZE);
...
static int GetPixelMonochrome(const BITMAPHEADER * const pHeader, const char * const pBuf, const unsigned int x, const unsigned int y)
{
...
static int GetPixel24bit(const BITMAPHEADER * const pHeader, const char * const pBuf, const unsigned int x, const unsigned int y)
{
    unsigned int pixelindex;
