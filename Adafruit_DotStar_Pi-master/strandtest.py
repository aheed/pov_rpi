...
numpixels = 33 # Number of LEDs in strip

# Here's how to control the strip from any two GPIO pins:
#datapin   = 11
#clockpin  = 8
#strip     = Adafruit_DotStar(numpixels, datapin, clockpin)
strip     = Adafruit_DotStar(numpixels) #SPI
...
#strip.setBrightness(1) # min brightness
...
#		if(color == 0): color = 0xFFFFFF # If black, reset to white
