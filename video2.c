/*
$ gcc ldclient.c bmp.c leddata.c video2.c -o video2 -lavformat -lavcodec -lavutil -lswscale -lm
$ ./video2 ~/Videos/WILDLIFE\ IN\ 4K\ \(ULTRA\ HD\).mp4
